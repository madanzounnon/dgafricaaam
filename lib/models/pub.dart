...
List accountList = [
   ...
   {"nom":"Langue","route":'/'},
   {"nom":"Nous contacter","route":'/contact'},
   {"nom":"A propos de nous","route":'/'},
   {"nom":"Déconnexion","route":'/'}
];
List<DropdownMenuItem<String>> get dropdownItems{
  List<DropdownMenuItem<String>> menuItems = [
    ...
    DropdownMenuItem(child: Text("EPARGNE CROISSANCE"),value: "EPARGNE CROISSANCE"),
...
List<DropdownMenuItem<String>> get typepieceItems{
  List<DropdownMenuItem<String>> menuItem = [
    ...
    DropdownMenuItem(child: Text("Pièce d'identité national"),value: "Pièce d'identité national"),
    DropdownMenuItem(child: Text("Carte Biométrique"),value: "Carte Biométrique"),
    DropdownMenuItem(child: Text("Passport"),value:"Passport"),
  ];
  return menuItem;
}

const String profileUrl ="https://images.unsplash.com/photo-1616597082843-de7ce757d548?ixid=MXwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw0N3x8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60";