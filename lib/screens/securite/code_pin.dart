...
class _CodePinScreenState extends State<CodePinScreen> {
                                      ...
                                      child: Container(
                                          ...
                                          child: TextButton(
                                            style: TextButton.styleFrom(
                                              shape:CircleBorder(side: BorderSide(color: const Color.fromARGB(31, 75, 75, 75),width: 1,style: BorderStyle.solid)),

                                          primary:Colors.white,
                                          foregroundColor: pPrimaryColor.withOpacity(0.3)
                                        ),
                                        onPressed: () {
                                          backspace();
                                        },
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text("Code Pin",style: TextStyle(fontSize: getProportionateScreenWidth(20),fontWeight: FontWeight.bold,color:pPrimaryColor),),
        Container(
          height: 30,
          child: Row(
